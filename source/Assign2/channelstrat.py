...
class ChannelSetup(VerosSetup):
    ...
    def set_topography(self, state):
        ...
        yy = npx.array([0, 4500, 40000-4500, 40000])
    ...
    def set_initial_conditions(self, state):
        ...
        t = 10 + (100 * (vs.zt[None, None, :] - vs.zt[0]) / -vs.zt[0])

        vs.temp = update(vs.temp, at[...], t[..., None])
