...
\begin{scope}[yshift=-4.2cm]
    ...
    % draw a red circle at (1.2,-0.4) with a dot in the center, labeled "Coriolis":
    \draw[thick, teal] (1.5,-1.7) circle (0.2);
    % draw an x in this circle with the same size as the radius of the circle:
    \draw[thick, teal] (1.5,-1.7) -- (1.5+0.141,-1.7+.141);
    \draw[thick, teal] (1.5,-1.7) -- (1.5-0.141,-1.7+0.141);
    \draw[thick, teal] (1.5,-1.7) -- (1.5+0.141,-1.7-0.141);
    \draw[thick, teal] (1.5,-1.7) -- (1.5-0.141,-1.7-0.141);
    % label as wind stress:
    \node[text=teal] at (1.5,-2.1) {$u_g$};
...
\begin{scope}[yshift=-9.5cm]
    ...
    \draw[thick, red, -{Stealth[scale=1.5]}, line width=2pt] (1.5,1.2) -- (1.5,2) node[right, below] {$\ \ \ \ \ \ \ \ \ \ \  PGF$};
    \draw[thick, red, -{Stealth[scale=1.5]}, line width=2pt] (1.5,0.8) -- (1.5,0.0) node[right, above] {$\ \ \ \ \ \ \ \ \ \ Cor.$};

    % thick teal arrow pointing down from the middle of the line at x=1.5 z=-0.3
    \draw[thick, teal, -{Stealth[scale=1.5]}, line width=1pt] (1.5,1) -- (2.5,1) node[midway, right] {$\ \ \ \ u_{g}$};
    ...
    \node at (-0.4, 1.7) [below, right] {middle};
